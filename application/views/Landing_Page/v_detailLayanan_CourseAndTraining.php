            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="service-details-text-area">
                        ...
                        <h3>Course & Trainings</h3>
                        <p>kursus dan pelatihan merupakan sebuah kegiatan yang bertujuan meningkatkan wawasan dan
                            ketrampilan. Karena dengan mengikuti kursus kita dapat menggali dan berdiskusi dengan pakar
                            yang ahli pada bidangnya.</p>
                        <p>Semua materi kursus kami tersedia dalam tingkatan yang bervariasi, mulai dari materi untuk
                            tingkat dasar hingga tingkat lanjut. Dan disamping itu, kami juga dapat menyediakan materi
                            kursus yang dapat dikustomisasi sesuai dengan kebutuhan peserta. </p>
                        <h4>Jasa Course & Trainings</h4>
                        <p>Eninva menawarkan jasa kursus & pelatihan dengan biaya terjangkau tetapi kualitas tetap nomor
                            satu Untuk menjaga kualitas dalam penyampaian materi training, maka kami memiliki team
                            pengajar
                            atau Instruktur dan Trainer yang merupakan para praktisi dan professional yang telah
                            berpengalaman bertahun-tahun lamanya dalam bidang IT dan tentunya telah mendapatkan
                            sertifikasi internasional sesuai dengan bidangnya masing-masing.</p>
                        <img src="<?php echo base_url() ?>assets/assets/images/service/sd2.jpg" alt="image">
                        <h4>Layanan Course & Trainings</h4>
                        <ul>
